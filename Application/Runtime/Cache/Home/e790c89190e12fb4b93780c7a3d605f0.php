...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/Public/Home/css/tabulous.css"/>
...
<div class="shop_new">
  ...
  <div class="tab_box">
    <div>
      <?php if(is_array($crazy)): $i = 0; $__LIST__ = $crazy;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Goods/index','id='.$item['id']);?>" style="display:block;width: 20%;float: left;text-align: center">
          <p><img src="/<?php echo ($item["goods_thumb"]); ?>" alt="" style="height: 100px;width: auto;"></p>
          <p style="white-space: nowrap;text-overflow:ellipsis; overflow:hidden;"><?php echo ($item["goods_name"]); ?></p>
          <p style="white-space: nowrap;text-overflow:ellipsis; overflow:hidden;"><?php echo ($item["shop_price"]); ?></p>
        </a><?php endforeach; endif; else: echo "" ;endif; ?>
    </div>
    <div class="hide">
      <?php if(is_array($hot)): $i = 0; $__LIST__ = $hot;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Goods/index','id='.$item['id']);?>" style="display:block;width: 20%;float: left;text-align: center">
          <p><img src="/<?php echo ($item["goods_thumb"]); ?>" alt="" style="height: 100px;width: auto;"></p>
          <p style="white-space: nowrap;text-overflow:ellipsis; overflow:hidden;"><?php echo ($item["goods_name"]); ?></p>
          <p style="white-space: nowrap;text-overflow:ellipsis; overflow:hidden;"><?php echo ($item["shop_price"]); ?></p>
        </a><?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    <div class="hide">
      <?php if(is_array($rec)): $i = 0; $__LIST__ = $rec;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Goods/index','id='.$item['id']);?>" style="display:block;width: 20%;float: left;text-align: center">
          <p><img src="/<?php echo ($item["goods_thumb"]); ?>" alt="" style="height: 100px;width: auto;"></p>
          <p style="white-space: nowrap;text-overflow:ellipsis; overflow:hidden;"><?php echo ($item["goods_name"]); ?></p>
          <p style="white-space: nowrap;text-overflow:ellipsis; overflow:hidden;"><?php echo ($item["shop_price"]); ?></p>
        </a><?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    <div class="hide">
      <?php if(is_array($new)): $i = 0; $__LIST__ = $new;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Goods/index','id='.$item['id']);?>" style="display:block;width: 20%;float: left;text-align: center">
          <p><img src="/<?php echo ($item["goods_thumb"]); ?>" alt="" style="height: 100px;width: auto;"></p>
          <p style="white-space: nowrap;text-overflow:ellipsis; overflow:hidden;"><?php echo ($item["goods_name"]); ?></p>
          <p style="white-space: nowrap;text-overflow:ellipsis; overflow:hidden;"><?php echo ($item["shop_price"]); ?></p>
        </a><?php endforeach; endif; else: echo "" ;endif; ?>
...
<script>
  ...
  <script type="text/javascript" src="/Public/Home/js/jquery.tabs.js"></script>
  <script>
    $(function(){
      $('.demo2').Tabs({
        event:'click'
