...
<div class="main-container ace-save-state" id="main-container">
  ...
  <form class="form-horizontal" role="form" action="" method="post">
    ...
    <div class="form-group">
      ...
      <div class="col-xs-12 col-sm-5">
        <span class="block input-icon input-icon-right">
          <input type="text" id="rule_name" class="width-100" name="rule_name" value="<?php echo ($info["rule_name"]); ?>">
    ...
    <div class="form-group">
      ...
      <div class="col-xs-12 col-sm-5">
        <span class="block input-icon input-icon-right">
          <input type="text" id="module_name" class="width-100" name="module_name" value="<?php echo ($info["module_name"]); ?>">
          <i class="ace-icon fa fa-leaf"></i>
        </span>
      </div>
      <div class="help-block col-xs-12 col-sm-reset inline">
    ...
    <div class="form-group">
      ...
      <div class="col-xs-12 col-sm-5">
        <span class="block input-icon input-icon-right">
          <input type="text" id="controller_name" class="width-100" name="controller_name" value="<?php echo ($info["controller_name"]); ?>">
          <i class="ace-icon fa fa-leaf"></i>
        </span>
      </div>
      <div class="help-block col-xs-12 col-sm-reset inline">
    ...
    <div class="form-group">
      ...
      <div class="col-xs-12 col-sm-5">
        <span class="block input-icon input-icon-right">
          <input type="text" id="action_name" class="width-100" name="action_name" value="<?php echo ($info["action_name"]); ?>">
          <i class="ace-icon fa fa-leaf"></i>
        </span>
      </div>
      <div class="help-block col-xs-12 col-sm-reset inline">
      ...
      <div class="col-xs-12 col-sm-5">
        <span class="block input-icon input-icon-right">
          <select class="chosen-select form-control" id="parent_id" name="parent_id" style="cursor: pointer">
            ...
            <?php if(is_array($rule)): $i = 0; $__LIST__ = $rule;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><option value="<?php echo ($item["id"]); ?>" <?php if(($info["parent_id"]) == $item["id"]): ?>selected<?php endif; ?>>
    ...
    <div class="form-group">
      ...
      <div class="col-xs-12 col-sm-5">
        <label>
          <input name="is_show" type="radio" class="ace" value="1" <?php if(($info["is_show"]) == "1"): ?>checked<?php endif; ?>>
