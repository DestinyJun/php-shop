    ...
    <div class="widget-header">
      <div class="widget-toolbar no-border" style="float: left;">
        <ul class="nav nav-tabs" id="recent-tab">
          <li  class="active"><a data-toggle="tab" href="#task-tab">通用属性</a></li>
          <li><a data-toggle="tab" href="#member-tab">商品属性</a></li>
          <li><a data-toggle="tab" href="#member-img">商品相册</a></li>
        </ul>
      </div>
    </div>
        ...
        <div class="tab-content padding-8">
          <div id="task-tab" class="tab-pane active">
            ...
            <div class="form-group">
              ...
              <div class="col-xs-12 col-sm-5">
                <span class="block input-icon input-icon-right">
                  <input type="number" id="cx_price" class="width-100" name="cx_price">
                  <i class="ace-icon fa fa-leaf"></i>
                </span>
              </div>
              <div class="help-block col-xs-12 col-sm-reset inline">
            ...
            <div class="form-group">
              ...
              <div class="col-xs-12 col-sm-5">
                <span class="block input-icon input-icon-right">
                  <input type="date" id="start" class="width-100" name="start">
                  <i class="ace-icon fa fa-leaf"></i>
                </span>
              </div>
              <div class="help-block col-xs-12 col-sm-reset inline">
            ...
            <div class="form-group">
              ...
              <div class="col-xs-12 col-sm-5">
                <span class="block input-icon input-icon-right">
                  <input type="date" id="end" class="width-100" name="end">
                  <i class="ace-icon fa fa-leaf"></i>
                </span>
              </div>
              <div class="help-block col-xs-12 col-sm-reset inline">
          ...
          <div id="member-img" class="tab-pane">
