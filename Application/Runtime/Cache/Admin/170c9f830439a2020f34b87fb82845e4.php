...
<div class="main-container ace-save-state" id="main-container">
  ...
  <div class="row">
    <div class="col-sm-4">
      <a href="<?php echo U('Admin/Admin/add');?>" class="btn btn-sm btn-warning">用户添加</a>
    </div>
    <!--<div class="col-sm-8">
    ...
    <?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($k % 2 );++$k;?><tr>
        ...
        <td>
          <?php if(($item["id"]) > "1"): ?><div class="hidden-sm hidden-xs btn-group">
              <a class="btn btn-xs btn-info" href="<?php echo U('edit','id='.$item['id']);?>" title="用户编辑">
                <i class="ace-icon fa fa-pencil bigger-120"></i>
              </a>
              <!--<button class="btn btn-xs btn-warning">
                <i class="ace-icon fa fa-flag bigger-120"></i>
              </button>-->
              <button class="btn btn-xs btn-danger" onclick="deleteItem('<?php echo ($item["id"]); ?>')" title="用户删除">
